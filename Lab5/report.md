...
![результат программы simpleid](image/3.png){ #fig:003 width=70% height=70%}
...
![результат программы simpleid2](image/5.png){ #fig:005 width=70% height=70%}

13.	Написали программу readfile.c

![программа readfile](image/6.png){ #fig:006 width=70% height=70%}
...
![результат программы readfile](image/7.png){ #fig:007 width=70% height=70%}
...
![исследование Sticky-бита](image/8.png){ #fig:008 width=70% height=70%}
