...
![Добавление пользователей в группу](image/1.png){ #fig:001 width=70% height=70% }
...
![Информация о пользователях](image/2.png){ #fig:002 width=70% height=70% }
...
![Содержимое файла /etc/group и регистрация в группе](image/3.png){ #fig:003 width=70% height=70% }
...
![Изменение прав у директории](image/4.png){ #fig:004 width=70% height=70% }
...
![Заполнение таблицы](image/5.png){ #fig:005 width=70% height=70% height=70% }
